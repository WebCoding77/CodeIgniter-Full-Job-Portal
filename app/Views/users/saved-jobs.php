...
<div class="container">
  ...
  <?php foreach($savedJobs as $job) : ?>
    <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
      ...
      <a href="<?php echo url_to('single.jobs', $job->job_id); ?>"></a>
      <div class="job-listing-logo">
        <img src="<?= base_url('public/assets/images/'.$job->compay_image.'')?>" alt="Free Website Template by Free-Template.co" class="img-fluid">
      </div>
